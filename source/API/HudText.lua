...
function HudText:constructor(player, x, y, alignment, ...)
	...
	local arguments = {...}
	local textString = (getmetatable(arguments[1]) == Color and "" or tostring(Color.new(255, 220, 0)))
	...
	self._freed = false
	self._color = (getmetatable(arguments[1]) == Color and arguments[1] or Color.new(255, 220, 0))
...
HudText._alignments = { -- Possible alignments.
	["left"] = 0,
	["center"] = 1,
	["right"] = 2
}
