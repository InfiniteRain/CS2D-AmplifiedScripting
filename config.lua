...

{
	...
	cs2dHooks = {
		...
		["flagtake"] = {player = {1}},
		["flashlight"] = {player = {1}},
		["hit"] = {player = {1, 2}, itemType = {3}},
		["hitzone"] = {image = {1}, player = {2}, itemType = {4}}, --TODO 253 - turret (any),  249 - vartiguant, 248 - soldier
		["hostagerescue"] = {player = {1}},
		["join"] = {player = {1}},
		["kill"] = {player = {1, 2}, itemType = {3}},
		["leave"] = {player = {1}},
		["log"] = {},
		["mapchange"] = {},
		["menu"] = {player = {1}},
		...
		["shieldhit"] = {player = {1, 2}, itemType = {3}},
		["spawn"] = {player = {1}},
		["spray"] = {player = {1}},
		["startround"] = {},
		["startround_prespawn"] = {},
